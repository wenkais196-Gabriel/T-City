...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    ...
    CreateThread(function()
        ...
        QBCore.Functions.GetPlayerData(function(PlayerData)
            ...
            local maxHealth = 200
            local health = PlayerData.metadata['health'] or maxHealth
            ...
            -- Restore injuries
            if PlayerData.metadata['injuries'] then
                local injuries = PlayerData.metadata['injuries']
                if injuries.limbs then
                    BodyParts = injuries.limbs
                    injured = {}
                ...
                if injuries.isBleeding then
                    isBleeding = tonumber(injuries.isBleeding) or 0
                end
                TriggerServerEvent('hospital:server:SyncInjuries', injuries)
            end
