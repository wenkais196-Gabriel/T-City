...
// tabs/AmbulanceConsole.vue — 🚑 救护车控制台
...
<template>
  <div>
    <div class="console-header">🚑 救护车控制台</div>
    <button class="prof-btn" @click="doAction('megaphone')" style="margin-bottom:8px">📢 PA 扩音喊话</button>
